...
from src.data_preprocessing import build_preprocess_with_control

NEW_TOKENS = ["<SHORT>", "<MEDIUM>", "<LONG>"]

def parse_args():
    ap = argparse.ArgumentParser()
    ap.add_argument("--config", type=str, default=None)
    ap.add_argument("--model_name", type=str, default="facebook/bart-large-cnn")
    ap.add_argument("--output_dir", type=str, default="results/controlled")
...
def main():
    ...
    preprocess_fn = build_preprocess_with_control(tokenizer, args.max_src_len, args.max_tgt_len, args.short_thr, args.medium_thr)
